...
class Query(object):
    ...
    def __init__(self, time_vect, dataset, frequency, coords, credentials, out):
        """
        Query class
        ...
        self.datasets = {'physchem': ['GLOBAL_REANALYSIS_PHY_001_030-TDS', 'global-reanalysis-phy-001-030-daily'],
                         'bio': ['GLOBAL_REANALYSIS_BIO_001_029-TDS', 'global-reanalysis-bio-001-029-daily']}

        self.all_subs = {'physchem': ['thetao', 'bottomT', 'so', 'zos', 'uo', 'vo'],
                         'bio': ['chl', 'o2', 'no3', 'po4', 'si']}
        print('FREQUENCY is set to %s' %(self.frequency))

        # self.datasets = {'physchem'            : ['GLOBAL_REANALYSIS_PHY_001_030-TDS', 'global-reanalysis-phy-001-030-%s' %(self.frequency)],
        #                  'bio'                 : ['GLOBAL_REANALYSIS_BIO_001_029-TDS', 'global-reanalysis-bio-001-029-%s' %(self.frequency)]
        #                 }
        # ###need an if statement since phyc daily data does not seem to exist
